...
<div class="container-fluid">
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-4 text-gray-800">Cetak Barang Masuk</h1>

	<div class="card col-10">
		<div class="card-body pl-0">
			<form class="col-10" method="post" action="<?= base_url('in/report') ?>">
	...
	<!-- Page Heading -->
	<h1 class="mt-3 h3 mb-4 text-gray-800">Laporan Barang Masuk</h1>
					...
					<tbody>
						<tr>
							...
							?>
								...
								<td><?= $gd->warna ?></td>
								<td><?= $gd->jumlah ?></td>
								<td><?= number_format($gd->harga_beli, 0, ',', '.') ?></td>
								<td><?= $gd->nama_pemasok ?></td>
								<td><?= $gd->added_by ?></td>
								<td><?= date("d/m/Y H:i:s", strtotime($gd->date_in)) ?></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
				</table>
