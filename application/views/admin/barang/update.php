...
<div class="container-fluid">
	<div class="col-lg-8">
		...
		<form class="user" method="post" action="<?= base_url('barang/update/' . $getBarang['id_barang']); ?>">
			<div class="form-group">
				<label for="item_id">Kode Barang</label>
				<input type="text" class="form-control" id="item_id" name="item_id" value="<?= $getBarang['id_barang'] ?>" readonly>
			</div>
			<div class="form-group">
				<label for="item_name">Nama Barang</label>
				<input type="text" class="form-control" id="item_name" name="item_name" placeholder="Masukkan nama barang" value="<?= $getBarang['nama_barang'];
																																	set_value('item_name'); ?>">
			...
			<div class="form-group" id="keterangan">
				...
				<input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Contoh 30x40, Rubber dll." value="<?= $getBarang['keterangan'];
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="color" name="color" placeholder="Masukkan warna barang" value="<?= $getBarang['warna'];
																															set_value('color'); ?>">
				<?= form_error('color', '<small class="text-danger pl-3">', '</small>'); ?>
			</div>
			<div class="form-group">
				<label for="buy_price">Harga Beli</label>
				<input type="text" class="form-control" id="buy_price" name="buy_price" placeholder="Masukkan angka" value="<?= $getBarang['harga_beli'];
																															set_value('buy_price'); ?>">
